...
public class Strategy0Old implements StrategyBehaviour 
{
	...
	public List<Meld> useStrategy(Player currPlayer) throws IOException 
	{
		...
		List<Meld> meldsPlayedThisTurn = new ArrayList<>();
		String handOrTable = "";
		...
		if(currPlayer.canPlayOnExistingMelds)
		{
			...
			{
				playStrategy(currPlayer,tableMelds,returnMelds); // <------ Change execution path here.
			}
